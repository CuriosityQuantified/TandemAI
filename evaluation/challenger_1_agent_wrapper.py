...
This module provides a wrapper to integrate test_config_challenger_1.py
...
BASELINE CONFIGURATION (Researcher Agent):
    ...
    - Config: test_config_challenger_1.py
...
def create_baseline_agent(agent_type: AgentType) -> callable:
    ...
    BASELINE CONFIGURATION DETAILS (Researcher):
        - Configuration: test_config_challenger_1
    ...
    from evaluation.configs.test_config_challenger_1 import graph
    ...
    def execute_research_query(query: str) -> Dict[str, Any]:
        ...
        Configuration: test_config_challenger_1 (Researcher)
...
def get_baseline_agent(agent_type: AgentType = "Researcher") -> callable:
    ...
    if agent_type not in _baseline_agent_instances:
        ...
        print(f"  Config: test_config_challenger_1")
...
if __name__ == "__main__":
    ...
    print("  - Config: test_config_challenger_1")
