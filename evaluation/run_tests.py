...
def create_agent_function():
    ...
    BASELINE CONFIGURATION:
        ...
        - Config: test_config_1_deepagent_supervisor_command
        - Prompt: benchmark_researcher_prompt V3
        - Model: Gemini 2.5 Flash
    """
    # Import baseline researcher agent wrapper
    from evaluation.baseline_agent_wrapper import get_baseline_agent

    print("✓ Loading baseline Researcher agent...")
    print("  Config: test_config_1_deepagent_supervisor_command")
    print("  Prompt: benchmark_researcher_prompt V3")
    print("  Model: Gemini 2.5 Flash")

    # Get baseline researcher agent (uses singleton pattern)
    agent_function = get_baseline_agent("Researcher")
