"""
Supervisor Agent System Prompt - Version 1.0 (Baseline)
...
- AgentOrchestra pattern implementation
...
PROMPT_PERFORMANCE = {
    "delegation_compliance": None,  # To be measured in baseline evaluation
...
KNOWN_ISSUES = """
- Delegation directive buried at line 120/295 (38% into prompt) - weak primacy effect
...
def get_supervisor_prompt(current_date: str) -> str:
    """
    Get supervisor prompt v1.0 with current date injected.
