"""
Challenger Researcher Prompt V2 - Phase 2: Maximum Citation Strictness

VERSION: 2.0 (Challenger #2)
DATE CREATED: 2025-11-15
CHALLENGER TYPE: Phase 1 + Phase 2 (Workflow + Citations)
BASELINE: benchmark_researcher_prompt.py V3.0
BUILDS ON: challenger_prompt_1.py V1.0

PHASE 1 FIXES (from V1 - VALIDATED ✅):
  ...
  ✅ PROVEN: Step completion 0% → 90% (4.5 avg steps completed)
  ✅ PROVEN: Test pass rate 0% → 100% (2/2 quick validation)

PHASE 2 ENHANCEMENTS (NEW in V2):
  ✨ NEW: Gold-standard citation format with quote verification
  ✨ NEW: Exact quotes MUST appear in both inline AND source list
  ✨ NEW: Numbered reference system [1], [2], [3] with full traceability
  ✨ NEW: Citation verification checkpoint before final response
  ✨ NEW: Concrete examples of perfect citation format
  🎯 TARGET: Has exact quotes 50% → 95%+
  🎯 TARGET: Has source URLs 59.4% → 98%+
  🎯 TARGET: Overall pass rate 100% (quick) → 70%+ (full 32-test)

CITATION FORMAT REQUIREMENTS:
  Every factual claim must include:
  1. Inline: "exact quote" [Source, URL, Date] [#]
  2. Source list: [#] "exact quote" - Source - URL - Date

  This dual-format ensures:
  - Instant verification (quote + URL in one place)
  - No ambiguity about which quote came from which source
  - Maximum transparency and fact-checking capability

VALIDATION PLAN:
  1. Quick test 2 queries to verify citation format compliance
  2. If citations perfect → Run 8-test validation
  3. If 8-test shows 60%+ pass → Run full 32-test evaluation
  4. Target: 70%+ overall pass rate with perfect citations

HYPOTHESIS:
  V1 fixed workflow (proven 90% step completion).
  V2 adds citation strictness to hit quality criteria.
  Combined: Expect 70%+ pass rate on full evaluation.
"""
